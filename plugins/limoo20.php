...
/*
  ...
  Copyright (c) 2012 Limoo20 SMS Panel, www.payam20.ir, www.limoo20.ir
...
*/
    ...
    /**
     * Limoo20 SMS Panel SMS_Sender Class
     * 
     * @package		payam20.ir 
     * @copyright 	http://www.payam20.ir
     */
    class SMS_Sender
    {
       /**
        ...
        */
        ...
        /**
         * This function is used to send SMS via http://www.payam20.ir
         * 
         * @param   string      Username
         * @param   string      Password
         * @param   string      Number (From - Example: 100002972)
	...
	//-- اطلاعات کلی پلاگین
	$pluginData[limoo20][type] = 'notify';
	$pluginData[limoo20][name] = 'پلاگین پیامک محصول';
	$pluginData[limoo20][uniq] = 'limoo20';
	$pluginData[limoo20][description] = 'ارسال اطلاعات خريد به تلفن همراه کاربر از طريق سرويس Limoo20 SMS Panel';
	$pluginData[limoo20][author][name] = 'Limoo20 SMS Panel';
	$pluginData[limoo20][author][url] = 'http://www.limoo20.ir';
	$pluginData[limoo20][author][email] = 'info@limoo20.ir';
	
	//-- فیلدهای تنظیمات پلاگین
	$pluginData[limoo20][field][config][1][title] = 'شماره ارسال';
	$pluginData[limoo20][field][config][1][name] = 'sender_number';
	$pluginData[limoo20][field][config][2][title] = 'نام کاربری ارسال';
	$pluginData[limoo20][field][config][2][name] = 'username';
	$pluginData[limoo20][field][config][3][title] = 'کلمه عبور ارسال';
	$pluginData[limoo20][field][config][3][name] = 'password';
	
	//-- تابع پردازش و ارسال اطلاعات
	function notify__limoo20($data,$output,$payment,$product,$cards)
	{
		global $db,$smarty;
